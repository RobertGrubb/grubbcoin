...
{
    const char* pszTimestamp = "1,000 Decade-Old Dormant Bitcoins Moved Today on Bitcoin's 12th Anniversary - 03/Jan/2021.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1609699476, 2088448287, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000eb8914fdf4dabb3495647d8962d11bcc216ef40fb174805f15efa05be0e"));
        assert(genesis.hashMerkleRoot == uint256S("0x0a9ec81daba174db00aab755c96a350906826b6c9967ae74d0e171c3d2f0b5a8"));
        ...
        // vSeeds.emplace_back("seed-a.grubbcoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.grubbcointools.com");
        // vSeeds.emplace_back("dnsseed.grubbcoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x00000eb8914fdf4dabb3495647d8962d11bcc216ef40fb174805f15efa05be0e")},
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.grubbcointools.com");
        // vSeeds.emplace_back("seed-b.grubbcoin.loshan.co.uk");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x32, 0x81, 0xCE};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x32, 0x89, 0x99};

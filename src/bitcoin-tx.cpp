...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " grubbcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  grubbcoin-tx [options] <hex-tx> [commands]  Update hex-encoded grubbcoin transaction\n" +
            "or:     grubbcoin-tx [options] -create [commands]   Create hex-encoded grubbcoin transaction\n" +
            "\n";

...
"""Verify that starting grubbcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start grubbcoin with -h for help text")
        ...
        self.log.info("Start grubbcoin with -version for version information")
        ...
        self.log.info("Start grubbcoind with -fakearg to make sure it does not start")

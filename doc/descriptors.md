# Support for Output Descriptors in GrubbCoin Core

Since GrubbCoin Core v0.17, there is support for Output Descriptors. This is a
...
on GrubbCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing GrubbCoin Core wallets, a convenience function `combo` is

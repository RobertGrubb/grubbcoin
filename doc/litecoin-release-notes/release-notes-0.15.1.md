...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 bites per kB (0.00001 GRB). This is to prepare for dropping the minimum transaction fee to 0.1 bites per kB (0.0001 GRB) in the next release.
